...
global_label_number = [0 for x in range(40)]
global_image_hash = []
...
class FaceDetector():
    def __init__(self):
        ...
        credentials = ServiceAccountCredentials.from_json_keyfile_name(
                        './My First Project-b0408eac9505.json', scopes=scopes)
    ...
    def crop_faces_dir(self,src_dir,des_dir,maxnum):
        ...
        label = folder_name
        des_dir_training = os.path.join(des_dir, folder_name)
        ...
        training_file = open(des_dir+'/'+folder_name+'.txt','a')
...
def main(argv):
    ...
    print("Length of cropped images : " + str(l1))

    if l1 < 100:
        l2 = 10
        l4 = 0.0002
    elif l1 >= 100 and l1 < 2000:
        l2 = 50
        l4 = 0.0002
    elif l1 > 2000:
        l2 = 64
    ...
    os.chdir("/home/capstone/DC/CropFace/out")
    os.system("mkdir dd")
    os.system("mv ./" + sys.argv[4] + " ./dd")
    os.system("mv dd " + sys.argv[4])
    os.chdir("/home/capstone/DC/CropFace")

    os.chdir("/home/capstone/DC")
    os.chdir("/home/capstone/DC/DCGAN")
    os.system("sudo python3 DCGAN_pytorch.py " + sys.argv[4] + " " + l3 + " " + l5)
    #os.system("qwerty!123")
